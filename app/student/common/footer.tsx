...
const Footer = () => {
  return (
    <footer className="bg-[#1F2937] text-white px-6 flex justify-center items-center flex-col">
      <div className="flex flex-col md:flex-row space-x-4 py-8 w-[80%]">
        <div className="flex flex-col items-center md:items-start mb-7 md:mb-0 md:w-1/3 text-[#9CA3AF]">
          ...
          <p className="text-sm">
            Empowering learners worldwide with <br></br> quality education and
            practical skills.
          </p>
        </div>
      ...
      <div className="border-t border-gray-700 text-gray-400 text-sm py-6 px-6 flex flex-col md:flex-row justify-between gap-4">
        <div className="text-center md:text-left">
          &copy; 2025 Xcrino. All rights reserved.
        </div>
      </div>
    </footer>
  );
