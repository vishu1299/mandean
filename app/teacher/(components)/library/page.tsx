      ...
      <div className="max-w-7xl  mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            >
              <DialogTrigger asChild>
                <Button className="bg-gradient-to-r from-green-500 to-green-500 hover:from-green-600 hover:to-green-600 text-white shadow-lg px-6 py-3 rounded-xl font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-green-400 hover:bg-green-50 transition-all duration-200 cursor-pointer group">
              <FileVideo className="w-12 h-12 text-slate-400 group-hover:text-green-500 mx-auto mb-3 transition-colors" />
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-green-400 hover:bg-green-50 transition-all duration-200 cursor-pointer group">
              <FileText className="w-12 h-12 text-slate-400 group-hover:text-green-500 mx-auto mb-3 transition-colors" />
              <p className="text-slate-700 font-medium mb-1">
